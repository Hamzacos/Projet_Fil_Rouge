...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
      <h1 class="page-header">Sugges User</h1>
        Table
      </h1>
        ...
        <table class="table">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
              <form action="deletSuggest" method="POST">
                <input type="hidden" name="id_suggest" value="<?php  echo $val['id_suggest'] ?>">

<?php
   ...
   $salary = $data->getAllSalary();

   if(isset($_POST['id_salary'])){
    $editsalary = new ratesalaryController();
    $sal = $editsalary->getOneRtae();
  }

  if(isset($_POST['status'])){
    $edit_salary = new ratesalaryController();
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
      ...
      <div class="table-responsive">
        <table class="table table-hover table-bordered">
          ...
          <tbody>
          <?php foreach($salary as $salarys): ?>
            <tr>
              <td><?php echo $salarys['Name'] ?></td>
              <td><?php echo $salarys['job'] ?></td>
              <td><?php echo $salarys['base_salary'] ?></td>
              <td><?php echo $salarys['years'] ?></td>
              <td><?php echo $salarys['location'] ?></td>
              <form action="" method="POST">
              <td><button type="submit" name="status" class="btn btn-danger btn" ><?php echo $salarys['status'] ?></button></td>
              <input type="hidden" name="id_salary" value="<?php echo  $salarys['id_salary'];?>">
              </form>
              <td>
              <form action="deleteSal" method="POST">
                <input type="hidden" name="id_salary" value="<?php  echo $salarys['id_salary'] ?>">

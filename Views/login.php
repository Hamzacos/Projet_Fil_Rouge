...
<body>
        ...
        <div class="container"><img src="assets/img/logo.png" style="width: 60px;height: 60px"><a class="navbar-brand d-flex align-items-center" href="#"></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-5"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-5">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"><a href="Sing_up"><button class="btn btn-primary" type="button" style="font-family: Poppins, sans-serif;background: rgb(58,56,69);">Sing Up</button></a></li>
                </ul>
            </div>
        </div>
    </nav>
    <div class="carousel slide" data-bs-ride="carousel" id="carousel-1" style="height: 600px;">
        <div class="carousel-inner h-100">
            <!-- <div class="carousel-item active h-100"><img class="w-100 d-block position-absolute h-100 fit-cover" src="assets/img/iStock-1034135148_xsidzp%20(1).jpg" alt="Slide Image" style="z-index: -1;"> </div> -->
            <img class="w-100 d-block position-absolute h-100 fit-cover" src="assets/img/iStock-1034135148_xsidzp (2).jpg" alt="Slide Image" style="z-index: -1;">
                        ...
                        <div class="col-12 col-sm-6 col-md-4 mt-5">
                                    ...
                                    <div class="mb-3">
                                     <form method="post">
                                      ...
                                      <!-- <button type="submit" class="btn btn-dark text-white w-100" name="submit">SIGN IN</button> -->
                                      <button class="btn btn-dark text-white w-100" type="submit" name="submit">Create Account</button>
    ...
    <section id="bg" class="bg" style="width: max;height: 350px;background: #e2dcdc;">
        <div class="container">
            <div class="row">
                <h1 class="text-center py-4">How Artemis-Jobs Works for You</h1>
                <div class="col-md-4 text-center"><img data-bss-hover-animate="pulse" src="assets/img/insurance-3603.svg" style="width: 113px; height: 113px;">
                    <h4 class="text-center">Compare Salaries</h4>
                </div>
                <div class="col-md-4 text-center"><img data-bss-hover-animate="pulse" src="assets/img/job-svgrepo-com.svg" style="width: 113px; height: 113px;">
                    <h4 class="text-center">Apply To Jobs</h4>
                </div>
                <div class="col-md-4 text-center"><img data-bss-hover-animate="pulse" src="assets/img/rating-star-1082.svg" style="width: 113px; height: 113px;">
                    <h4 class="text-center">Apply To Jobs</h4>
                </div>
            </div>
        </div>
        ...
        <div class="container py-4 py-lg-5">
            <div class="row my-4">
                ...
                <div class="col-lg-4 col-md-6 mb-4 mb-md-0">
                    <h5 class="text-uppercase mb-4">Artemis-Job</h5>
                    <ul class="list-unstyled">
                        <li class="mb-2">
                          <a href="#!" class="text-dark"><i class="fas fa-paw pe-3"></i>About/Press</a>
                        </li>
                        <li class="mb-2">
                          <a href="#!" class="text-dark"><i class="fas fa-paw pe-3"></i>Research</a>
                          </li>
                          <li class="mb-2">
                            <a href="#!" class="text-dark"><i class="fas fa-paw pe-3"></i>Guides</a>
                            </li>
            </div>
            <div class="col-lg-4 col-md-6 mb-4 mb-md-0">
                <h5 class="text-uppercase mb-4">Employers</h5>
                <ul class="list-unstyled">
                    <li class="mb-2">
                      <a href="#!" class="text-dark"><i class="fas fa-paw pe-3"></i>Get a Free Employer Account
                      </a>
                    </li>
                    <li class="mb-2">
                      <a href="#!" class="text-dark"><i class="fas fa-paw pe-3"></i>Employer Center</a>
                      </li>
            </div>
            <hr>

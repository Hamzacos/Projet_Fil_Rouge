    ...
    <div class="container-fluid bg-light">
        <div class="row justify-content-center">
            <div class="col-9 border  mt-5 mb-5 bg-white">
                <h1 class="mt-3 text-center">What would you like to contribute?</h1>
...
employee?</p>
  ...
  <label class="btn btn-secondary" for="option2">Former</label>
    ...
    <label for="inputPassword" class="col-sm-3 col-form-label">Employer Name *</label>
    <div class="col-sm-7">
      <input type="text" class="form-control"  placeholder="Company">
    </div>
  </div> -->
            <div class="w-100 d-flex justify-content-end">
                <button id="submit" type="button" class="btn btn-dark col-4 mt-5">Submit </button>
            </div>
                </form>
            </div>
    </div>
...
var input = document.querySelector('input[name="exampleRadios"]:checked').value;
